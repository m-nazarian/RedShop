...
def dashboard_callback(request, context):
    ...
    kpi_data = [
        {"title": "درآمد کل", "metric": f"{format_price(total_income)} تومان", "footer": "مجموع فروش موفق"},
        {"title": "سفارشات جدید", "metric": str(new_orders_count), "footer": "منتظر بررسی"},
        {"title": "کاربران", "metric": str(total_users), "footer": "کل کاربران ثبت‌نامی"},
    ]
